...
{
    /// <summary>This Animation will Softly fade from the current scene to white</summary>
    /// <author>Daniel Cuccia</author>
    public class SceneAnimateOut_WhiteFade : CSceneAnimateOut
    {
        Texture2D blank;
        Rectangle rect;
        ...
        public SceneAnimateOut_WhiteFade(Scene scene, AnimationCompleteCallback onComplete)
