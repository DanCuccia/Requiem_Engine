...
{
    /// <summary>This Animation will Softly fade from white to the current scene</summary>
    /// <author>Daniel Cuccia</author>
    public class SceneAnimateIn_WhiteFade : CSceneAnimateIn
    {
        Texture2D blank;
        Rectangle rect;
        ...
        public SceneAnimateIn_WhiteFade(Scene scene, AnimationCompleteCallback onComplete)
